...
In `q`-color classes `N_i`, the active pairs rotate as `N_1N_2`, `N_0N_1`, `N_3N_0`, `N_2N_3`, with the
corresponding switch sets `N_2N_3`, `N_1N_2`, `N_0N_1`, `N_3N_0`.
If opposite residues are both high-active target-avoidance endpoints on a shared certificate,
